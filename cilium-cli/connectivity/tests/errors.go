...
func NoErrorsInLogs(ciliumVersion semver.Version) check.Scenario {
	...
	warningLogExceptions := []logMatcher{cantEnableJIT, delMissingService, podCIDRUnavailable,
		...
		endpointMapDeleteFailed, etcdClusterIDChanged, epRestoreMissingState}
...
const (
	...
	etcdClusterIDChanged      stringMatcher = "etcd cluster ID has changed:"                                          // cf. https://github.com/cilium/cilium/issues/35865
